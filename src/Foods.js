...
export class Foods extends Component {
    ...
    async componentDidMount(){
        ...
        var searchurl=`https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=${apikey}&tags=food&per_page=30&format=json&nojsoncallback=1`;
