...
class Mountains extends React.Component{
    ...
    async componentDidMount(){
        ...
        var searchurl=`https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=${apikey}&tags=mountain&per_page=30&format=json&nojsoncallback=1`;
    ...
    render(){
        return(
            <div >
                <Header/>
                <h1 id="content">Mountains</h1>
                <div id="mountaincontent">
                    {this.state.btnimg}  
                </div>
                <Footer/>
