...
export class Beachs extends Component {
    constructor(props){
        super(props)
        this.state={
            btnimg:null,
    ...
    async componentDidMount(){
        ...
        var searchurl=`https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=${apikey}&tags=beach&per_page=30&format=json&nojsoncallback=1`;
